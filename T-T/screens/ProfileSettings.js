        ...
        <View style = {styles.container}>
          <LinearGradient colors={['rgba(223, 238, 235, 0.8)', 'transparent']} style={styles.background}/>
            <View style = {styles.optionsContainer}>
                <Text style={{marginTop: "5%", fontSize: 20}}>What is your current Goal?</Text>
                <TextInput 
                style={{height:40, width: "95%", marginTop: "3%", borderWidth:1, bordercolor: "Black"}}
                placeholder="Current Goal"
                onChangeText = {goal => setGoal(goal)}
                defaultValue= {goal}
                />
                <Text style={{marginTop: "5%", fontSize: 20}}>Literally Anything else?</Text>
                <TextInput 
                style={{height:40, width: "95%", marginTop: "3%", borderWidth:1, bordercolor: "Black"}}
                placeholder="yes"
                />
