...
export function Section1() {
    ...
    <View style = {styles.container}> 
        ...
        <Text style={styles.question}>Welcome Please input your measurements!</Text>
        <View style={styles.toggle}>
            <Text style={styles.dropTitle}>Metric System</Text>
            <Switch onValueChange={toggleSystem} value ={isEnabled} style={{ marginRight:"13%", transform: [{ scaleX: 1.5 }, { scaleY: 1.5 }] }}/>
        </View>
