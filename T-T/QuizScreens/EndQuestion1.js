...
export function DaysOfWorkout({navigation}) {
    ...
    if (daysOfWorkout != "nothing"){
      setDays().then(() => {setDB(daysOfWorkout, 10)})
    }
        ...
        <View style = {styles.container}>
          <LinearGradient colors={['rgba(223, 238, 235, 0.8)', 'transparent']} style={styles.background}/>
            ...
            <View style= {styles.buttons}>
              <Button color={'rgb(81, 130, 135)'} title="1-2 days" onPress={()=> setDays("1-2 days")} /> 
              <Button color={'rgb(81, 130, 135)'} title="2-3 days" onPress={()=> setDays("2-3 days")} />
              <Button color={'rgb(81, 130, 135)'} title="3-4 days" onPress={()=> setDays("3-4 days")} />
              <Button color={'rgb(81, 130, 135)'} title="4-5 days" onPress={()=> setDays("4-5 days")} />
              <Button color={'rgb(81, 130, 135)'} title="6-7 days" onPress={()=> setDays("6-7 days")} />
            </View>
        </View>
    )
}
